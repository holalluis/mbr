...
<!--TITLE-->	<h2 onclick=window.location="sql.php" style=cursor:pointer>Execute SQL query (for advanced users)</h2>
<h4>To learn MySQL commands visit <a target=_blank href=http://dev.mysql.com/doc/refman/5.7/en/entering-queries.html>MySQL tutorial</a></h4>
...
<?php
	...
	//check if query contains not permitted words like DELETE
	if(strpos(strtoupper($sql),'DELETE')!==false) 
		die("<b>ERROR operation not allowed</b>");
?>
